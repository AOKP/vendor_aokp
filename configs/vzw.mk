...
ifeq ($(TARGET_UNIFIED_DEVICE),true)
    PRODUCT_COPY_FILES += \
        vendor/aokp/prebuilt/vzw/etc/permissions/com.vzw.hardware.ehrpd.xml:system/proprietary/vzw/etc/permissions/com.vzw.har$
        vendor/aokp/prebuilt/vzw/etc/permissions/com.vzw.hardware.lte.xml:system/proprietary/vzw/etc/permissions/com.vzw.hardw$
        vendor/aokp/prebuilt/vzw/etc/permissions/com.vzw.vzwapnlib.xml:system/proprietary/vzw/etc/permissions/com.vzw.vzwapnli$
